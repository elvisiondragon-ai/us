...
export default function ELVision5000() {
  // Facebook Pixel Code
  useEffect(() => {
  ...
  const testimonials: TextTestimonialType[] = [
    ...
    },
    {
      ...
      image: "👩‍💼",
      rating: 5,
      text: "I thought I was 'done' financially. Turns out there's a next level: manifestation without force. $5000 is the best investment compared to $50k seminars that are just theory."
    },
    {
      name: "Stephanie Chen",
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gradient-to-r from-yellow-900/30 to-amber-900/30 border border-yellow-500/30 rounded-2xl p-10 backdrop-blur-sm mb-12">
              ...
              <div className="text-5xl font-bold text-yellow-400 mb-3">$5,000</div>
            ...
            <button 
              ...
              onClick={() => {
                ...
                window.open('https://wa.me/62895325633487?text=Hi%20I%20would%20like%20to%20apply%20$5000%20VIP%201%3A1%20%0AName:%20%0ASpecific%20Goal:%3A', '_blank');
              }}
            >
